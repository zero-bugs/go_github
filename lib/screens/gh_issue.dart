...
import 'package:gogithub/scaffolds/long_list.dart';
import 'package:gogithub/utils/global.dart';
import 'package:gogithub/widgets/action_button.dart';
import 'package:gogithub/widgets/avatar.dart';
import 'package:gogithub/widgets/comment_item.dart';
import 'package:gogithub/widgets/link.dart';
import 'package:gogithub/widgets/timeline_item.dart';
...
''';
  ...
  Future _queryIssue({String cursor, bool trailing = false}) async {
    ...
    var data = await Provider.of<AuthModel>(context).graphQuery('''
